...
#define MXT_LOGANDTHROW_T(t,...) throw ::ASMException(::Logger::logFrom(__FILE__,__LINE__,"%s [['%s', '%s':%d,%d]]",::string_format(__VA_ARGS__).c_str(),(t).str().c_str(),(t).filename().c_str(),(t).line(),(t).word()))
