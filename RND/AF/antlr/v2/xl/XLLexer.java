// $ANTLR 2.7.7 (20111217): "xl.g" -> "XLLexer.java"$
...
public class XLLexer extends antlr.CharScanner implements XLLexerTokenTypes, TokenStream
 {
public XLLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public XLLexer(Reader in) {
	this(new CharBuffer(in));
}
public XLLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public XLLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("newLine", this), new Integer(54));
	literals.put(new ANTLRHashString("elsif", this), new Integer(48));
	literals.put(new ANTLRHashString("get", this), new Integer(53));
	literals.put(new ANTLRHashString("if", this), new Integer(46));
	literals.put(new ANTLRHashString("type", this), new Integer(35));
	literals.put(new ANTLRHashString("program", this), new Integer(30));
	literals.put(new ANTLRHashString("while", this), new Integer(50));
	literals.put(new ANTLRHashString("var", this), new Integer(33));
	literals.put(new ANTLRHashString("record", this), new Integer(38));
	literals.put(new ANTLRHashString("end", this), new Integer(32));
	literals.put(new ANTLRHashString("of", this), new Integer(37));
	literals.put(new ANTLRHashString("then", this), new Integer(47));
	literals.put(new ANTLRHashString("or", this), new Integer(59));
	literals.put(new ANTLRHashString("mod", this), new Integer(57));
	literals.put(new ANTLRHashString("else", this), new Integer(49));
	literals.put(new ANTLRHashString("Boolean", this), new Integer(40));
	literals.put(new ANTLRHashString("constant", this), new Integer(34));
	literals.put(new ANTLRHashString("array", this), new Integer(36));
	literals.put(new ANTLRHashString("when", this), new Integer(44));
	literals.put(new ANTLRHashString("Integer", this), new Integer(39));
	literals.put(new ANTLRHashString("skipLine", this), new Integer(55));
	literals.put(new ANTLRHashString("and", this), new Integer(58));
	literals.put(new ANTLRHashString("not", this), new Integer(56));
	literals.put(new ANTLRHashString("loop", this), new Integer(51));
	literals.put(new ANTLRHashString("exit", this), new Integer(43));
	literals.put(new ANTLRHashString("procedure", this), new Integer(41));
	literals.put(new ANTLRHashString("begin", this), new Integer(31));
	literals.put(new ANTLRHashString("put", this), new Integer(52));
