...
const std::string editor::Settings::MAP_BUTTON_LAYERSELECT[] = {"select0", "select1", "select2", "select3"};
const std::string editor::Settings::MAP_BUTTON_UNDO("undo_btn");
const std::string editor::Settings::MAP_BUTTON_REDO("redo_btn");
